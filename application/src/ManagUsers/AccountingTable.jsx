...
const AccountingTable = () => {
    const columns = [
        { name: 'Status', sorting: 'ascending', width: '145px' },
        { name: ' First Name', sorting: 'ascending', width: '145px' },
        { name: 'Last Name', sorting: 'ascending', width: '146px' },
        { name: 'Role', sorting: 'ascending', width: '149px' },
        { name: 'Email', sorting: 'ascending', width: '145px' },
        { name: 'Phone', sorting: 'ascending', width: '146px' },
        { name: 'Action', sorting: 'ascending', width: '130px' },
        { name: 'Activate/Inactite', sorting: 'ascending', width: '150px' },
    ];
    return (
