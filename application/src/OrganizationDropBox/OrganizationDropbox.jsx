...
function OrganizationDropBox() {
    ...
    return (
     ...
     <div >
            ...
            <div className="panel-title" style={{ paddingTop: '10px', paddingLeft: '10px', marginBottom: '20px',fontWeight :'bold',paddingBottom:'10px' }}>Organization DropBox</div>
                        ...
                        <div className="panel-title" style={{ paddingTop: '10px', paddingLeft: '10px', paddingBottom: '0px' }}>
                            <div className="row">
                                ...
                                <div className="col-md-4" style={{ paddingRight :'25px'}}>
                                    <button disabled={true} className="btn btn-success pull-right" type="button">Upload Now</button>
                                </div>
                            </div>
                        </div>
